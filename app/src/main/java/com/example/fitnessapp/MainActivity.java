...
import com.example.fitnessapp.intro.MainIntroActivity;
import com.example.fitnessapp.utils.CustomExceptionHandler;
...
//    private BodyPartListFragment mpBodyPartListFrag = null;
    ...
    private static Profile mCurrentProfile = null;
...
//        }
        ...
        // MY TEST
        dataList.add(new DrawerItem("Test", R.drawable.ic_back2, true));
        // MY TEST
...
////        }
    ...
    public static Profile getCurrentProfil() {
